...
## Summary
Reference entry describing the DHCP_TIMEOUT error, its trigger conditions, and the standard resolution workflow for Mesh Extender units operating on Fixed Wireless.
...
- Firmware Notes: FW-0002

## Tags
error-code, dhcp_timeout, fixed wireless, mesh extender, diagnostics
