...
## Summary
Reference entry describing the DNS_UNREACHABLE error, its trigger conditions, and the standard resolution workflow for VoIP ATA units operating on 5G Home Internet.
...
- Firmware Notes: FW-0003

## Tags
error-code, dns_unreachable, 5g home internet, voip ata, diagnostics
