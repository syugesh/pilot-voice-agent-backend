...
## Summary
Reference entry describing the IPV6_PD_FAIL error, its trigger conditions, and the standard resolution workflow for DSL Modem units operating on Cable/DOCSIS.
...
- Firmware Notes: FW-0007

## Tags
error-code, ipv6_pd_fail, cable/docsis, dsl modem, diagnostics
