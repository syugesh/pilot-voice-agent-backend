...
## Summary
Reference entry describing the VPN_IKE_FAIL error, its trigger conditions, and the standard resolution workflow for WiFi 6 Router units operating on 5G Home Internet.
...
- Firmware Notes: FW-0009

## Tags
error-code, vpn_ike_fail, 5g home internet, wifi 6 router, diagnostics
