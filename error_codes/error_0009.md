...
## Summary
Reference entry describing the NAT_TABLE_FULL error, its trigger conditions, and the standard resolution workflow for Mesh Extender units operating on GPON.
...
- Firmware Notes: FW-0010

## Tags
error-code, nat_table_full, gpon, mesh extender, diagnostics
