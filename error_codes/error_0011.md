...
## Summary
Reference entry describing the CONFIG_CORRUPT error, its trigger conditions, and the standard resolution workflow for Gateway Router units operating on Fiber.
...
- Firmware Notes: FW-0012

## Tags
error-code, config_corrupt, fiber, gateway router, diagnostics
