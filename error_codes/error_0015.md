...
## Summary
Reference entry describing the CERT_EXPIRED error, its trigger conditions, and the standard resolution workflow for Cable Modem units operating on GPON.
...
- Firmware Notes: FW-0016

## Tags
error-code, cert_expired, gpon, cable modem, diagnostics
