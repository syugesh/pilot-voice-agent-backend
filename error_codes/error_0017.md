# Error Code Reference: POWER_BROWNOUT

**Document ID:** ERR-0017
**Category:** Error Code
...
## Summary
Reference entry describing the POWER_BROWNOUT error, its trigger conditions, and the standard resolution workflow for Mesh Extender units operating on Fiber.

## Error Description
Device detected unstable input power. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If POWER_BROWNOUT recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0018
- Product Manual: MAN-0018
- Firmware Notes: FW-0018

## Tags
error-code, power_brownout, fiber, mesh extender, diagnostics
