# Error Code Reference: BANDWIDTH_CAP_HIT

**Document ID:** ERR-0019
**Category:** Error Code
...
## Summary
Reference entry describing the BANDWIDTH_CAP_HIT error, its trigger conditions, and the standard resolution workflow for Gateway Router units operating on Fixed Wireless.

## Error Description
Subscriber data cap threshold reached. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If BANDWIDTH_CAP_HIT recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0020
- Product Manual: MAN-0020
- Firmware Notes: FW-0020

## Tags
error-code, bandwidth_cap_hit, fixed wireless, gateway router, diagnostics
