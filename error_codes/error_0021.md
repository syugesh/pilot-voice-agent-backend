# Error Code Reference: DHCP_TIMEOUT

**Document ID:** ERR-0021
**Category:** Error Code
...
## Summary
Reference entry describing the DHCP_TIMEOUT error, its trigger conditions, and the standard resolution workflow for ONT units operating on GPON.

## Error Description
No DHCP offer received within timeout window. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If DHCP_TIMEOUT recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0022
- Product Manual: MAN-0022
- Firmware Notes: FW-0022

## Tags
error-code, dhcp_timeout, gpon, ont, diagnostics
