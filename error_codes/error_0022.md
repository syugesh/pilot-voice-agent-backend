...
## Summary
Reference entry describing the DNS_UNREACHABLE error, its trigger conditions, and the standard resolution workflow for DSL Modem units operating on DSL.
...
- Firmware Notes: FW-0023

## Tags
error-code, dns_unreachable, dsl, dsl modem, diagnostics
