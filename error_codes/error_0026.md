# Error Code Reference: IPV6_PD_FAIL

**Document ID:** ERR-0026
**Category:** Error Code
...
## Summary
Reference entry describing the IPV6_PD_FAIL error, its trigger conditions, and the standard resolution workflow for VoIP ATA units operating on 5G Home Internet.

## Error Description
DHCPv6 prefix delegation request failed. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If IPV6_PD_FAIL recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0027
- Product Manual: MAN-0027
- Firmware Notes: FW-0027

## Tags
error-code, ipv6_pd_fail, 5g home internet, voip ata, diagnostics
