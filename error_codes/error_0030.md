...
## Summary
Reference entry describing the TEMP_HIGH error, its trigger conditions, and the standard resolution workflow for DSL Modem units operating on Cable/DOCSIS.
...
- Firmware Notes: FW-0031

## Tags
error-code, temp_high, cable/docsis, dsl modem, diagnostics
