# Error Code Reference: ONT_REGISTER_FAIL

**Document ID:** ERR-0033
**Category:** Error Code
...
## Summary
Reference entry describing the ONT_REGISTER_FAIL error, its trigger conditions, and the standard resolution workflow for Mesh Extender units operating on GPON.

## Error Description
ONT failed to register with OLT. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If ONT_REGISTER_FAIL recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0034
- Product Manual: MAN-0034
- Firmware Notes: FW-0034

## Tags
error-code, ont_register_fail, gpon, mesh extender, diagnostics
