...
## Summary
Reference entry describing the QOS_POLICY_ERR error, its trigger conditions, and the standard resolution workflow for VoIP ATA units operating on DSL.
...
- Firmware Notes: FW-0035

## Tags
error-code, qos_policy_err, dsl, voip ata, diagnostics
