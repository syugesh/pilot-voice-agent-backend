# Error Code Reference: CERT_EXPIRED

**Document ID:** ERR-0035
**Category:** Error Code
...
## Summary
Reference entry describing the CERT_EXPIRED error, its trigger conditions, and the standard resolution workflow for Gateway Router units operating on Fiber.

## Error Description
TR-069 device certificate expired. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If CERT_EXPIRED recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0036
- Product Manual: MAN-0036
- Firmware Notes: FW-0036

## Tags
error-code, cert_expired, fiber, gateway router, diagnostics
