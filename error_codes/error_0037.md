...
## Summary
Reference entry describing the POWER_BROWNOUT error, its trigger conditions, and the standard resolution workflow for ONT units operating on Fixed Wireless.
...
- Firmware Notes: FW-0038

## Tags
error-code, power_brownout, fixed wireless, ont, diagnostics
