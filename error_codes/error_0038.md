...
## Summary
Reference entry describing the WIFI_RADIO_FAIL error, its trigger conditions, and the standard resolution workflow for DSL Modem units operating on 5G Home Internet.
...
- Firmware Notes: FW-0039

## Tags
error-code, wifi_radio_fail, 5g home internet, dsl modem, diagnostics
