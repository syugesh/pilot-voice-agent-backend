...
## Summary
Reference entry describing the BANDWIDTH_CAP_HIT error, its trigger conditions, and the standard resolution workflow for Cable Modem units operating on GPON.
...
- Firmware Notes: FW-0040

## Tags
error-code, bandwidth_cap_hit, gpon, cable modem, diagnostics
