...
## Summary
Reference entry describing the WAN_AUTH_FAIL error, its trigger conditions, and the standard resolution workflow for WiFi 6 Router units operating on DSL.
...
- Firmware Notes: FW-0041

## Tags
error-code, wan_auth_fail, dsl, wifi 6 router, diagnostics
