...
## Summary
Reference entry describing the LOS_ALARM error, its trigger conditions, and the standard resolution workflow for Gateway Router units operating on Fixed Wireless.
...
- Firmware Notes: FW-0044

## Tags
error-code, los_alarm, fixed wireless, gateway router, diagnostics
