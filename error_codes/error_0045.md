# Error Code Reference: FW_CHECKSUM_ERR

**Document ID:** ERR-0045
**Category:** Error Code
...
## Summary
Reference entry describing the FW_CHECKSUM_ERR error, its trigger conditions, and the standard resolution workflow for ONT units operating on GPON.

## Error Description
Firmware image failed checksum validation. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If FW_CHECKSUM_ERR recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0046
- Product Manual: MAN-0046
- Firmware Notes: FW-0046

## Tags
error-code, fw_checksum_err, gpon, ont, diagnostics
