...
## Summary
Reference entry describing the IPV6_PD_FAIL error, its trigger conditions, and the standard resolution workflow for DSL Modem units operating on DSL.
...
- Firmware Notes: FW-0047

## Tags
error-code, ipv6_pd_fail, dsl, dsl modem, diagnostics
