# Error Code Reference: TEMP_HIGH

**Document ID:** ERR-0050
**Category:** Error Code
...
## Summary
Reference entry describing the TEMP_HIGH error, its trigger conditions, and the standard resolution workflow for VoIP ATA units operating on 5G Home Internet.

## Error Description
Device internal temperature exceeded safe threshold. This error typically surfaces in the device's system log and, on managed devices, is also reported to the ISP's TR-069/ACS management platform or SNMP trap receiver.
...
## Escalation Rules
If TEMP_HIGH recurs 3 or more times within a 24-hour period for the same device, escalate to Tier 2 Network Operations immediately, referencing this document ID. If the device is under warranty and hardware fault is confirmed, initiate an RMA per the Equipment Replacement SOP.

## Related Documents
- Troubleshooting Guide: TS-0051
- Product Manual: MAN-0001
- Firmware Notes: FW-0001

## Tags
error-code, temp_high, 5g home internet, voip ata, diagnostics
