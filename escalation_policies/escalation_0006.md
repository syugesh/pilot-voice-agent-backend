# Escalation Policy: Multi-Site Enterprise Outage

**Document ID:** ESC-0006
**Category:** Escalation Policy
**Severity Classification:** P3 - Medium
**Applicable Service:** BT Openreach 5G Home Internet
**Owner:** BT Openreach Customer Care Leadership

## Summary
Defines the escalation path, response time targets, and approval requirements when a Tier 1 or Tier 2 agent encounters a case involving multi-site enterprise outage.

## Trigger Conditions
- Customer explicitly requests escalation or expresses intent to cancel service or pursue legal/regulatory action.
- Case matches the pattern of multi-site enterprise outage as defined by the classification rules in the CRM case categorization module.
...
4. **Duty Manager:** For cases involving multi-site enterprise outage, the Duty Manager must be notified within 15 minutes of escalation trigger and must approve any compensation, credit, or executive communication.
...
## Related Documents
- SOP: SOP-0007
- Historical Case Reference: CASE-0007

## Tags
escalation, p3 - medium, 5g home internet, bt openreach, sla
