# Escalation Policy: Social Media Public Complaint

**Document ID:** ESC-0039
**Category:** Escalation Policy
**Severity Classification:** P4 - Low
**Applicable Service:** BT Openreach Fiber
**Owner:** BT Openreach Customer Care Leadership

## Summary
Defines the escalation path, response time targets, and approval requirements when a Tier 1 or Tier 2 agent encounters a case involving social media public complaint.

## Trigger Conditions
- Customer explicitly requests escalation or expresses intent to cancel service or pursue legal/regulatory action.
- Case matches the pattern of social media public complaint as defined by the classification rules in the CRM case categorization module.
...
4. **Duty Manager:** For cases involving social media public complaint, the Duty Manager must be notified within 15 minutes of escalation trigger and must approve any compensation, credit, or executive communication.
...
## Related Documents
- SOP: SOP-0040
- Historical Case Reference: CASE-0040

## Tags
escalation, p4 - low, fiber, bt openreach, sla
