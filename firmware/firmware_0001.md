# Firmware Release Notes: Netgear Nighthawk RAX50 Router - v4.3.7

**Document ID:** FW-0001
**Category:** Firmware
**Device:** Netgear Nighthawk RAX50 Router
...
## Summary
Release notes and deployment guidance for firmware version v4.3.7 on the Netgear Nighthawk RAX50 Router, distributed to Verizon Fixed Wireless subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Netgear Nighthawk RAX50 Router devices in the Verizon fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, netgear nighthawk rax50 router, fixed wireless, verizon, release-notes
