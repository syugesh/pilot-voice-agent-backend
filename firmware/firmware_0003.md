# Firmware Release Notes: Calix 844G-1 ONT - v6.5.21
...
## Summary
Release notes and deployment guidance for firmware version v6.5.21 on the Calix 844G-1 ONT, distributed to Airtel GPON subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Calix 844G-1 ONT devices in the Airtel fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, calix 844g-1 ont, gpon, airtel, release-notes
