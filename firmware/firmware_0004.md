# Firmware Release Notes: TP-Link Archer AX73 - v7.6.28
...
## Summary
Release notes and deployment guidance for firmware version v7.6.28 on the TP-Link Archer AX73, distributed to Jio DSL subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible TP-Link Archer AX73 devices in the Jio fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, tp-link archer ax73, dsl, jio, release-notes
