# Firmware Release Notes: Cisco DPC3941T Gateway - v3.7.5
...
## Summary
Release notes and deployment guidance for firmware version v3.7.5 on the Cisco DPC3941T Gateway, distributed to AT&T Fiber subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Cisco DPC3941T Gateway devices in the AT&T fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, cisco dpc3941t gateway, fiber, at&t, release-notes
