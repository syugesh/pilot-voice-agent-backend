# Firmware Release Notes: Huawei HG8245H ONT - v4.8.12
...
## Summary
Release notes and deployment guidance for firmware version v4.8.12 on the Huawei HG8245H ONT, distributed to Cisco TAC Cable/DOCSIS subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Huawei HG8245H ONT devices in the Cisco TAC fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, huawei hg8245h ont, cable/docsis, cisco tac, release-notes
