# Firmware Release Notes: Zyxel VMG8825 DSL Router - v5.9.19

**Document ID:** FW-0007
**Category:** Firmware
**Device:** Zyxel VMG8825 DSL Router
**Applicable Technology:** Fixed Wireless
**Release Version:** v5.9.19
**Release Date:** 2025-08-17
**Distributed By:** Xfinity Network Engineering

## Summary
Release notes and deployment guidance for firmware version v5.9.19 on the Zyxel VMG8825 DSL Router, distributed to Xfinity Fixed Wireless subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Zyxel VMG8825 DSL Router devices in the Xfinity fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, zyxel vmg8825 dsl router, fixed wireless, xfinity, release-notes
