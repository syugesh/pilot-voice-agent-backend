# Firmware Release Notes: Sagemcom F@st 5566 Gateway - v7.1.3
...
## Summary
Release notes and deployment guidance for firmware version v7.1.3 on the Sagemcom F@st 5566 Gateway, distributed to Deutsche Telekom GPON subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Sagemcom F@st 5566 Gateway devices in the Deutsche Telekom fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, sagemcom f@st 5566 gateway, gpon, deutsche telekom, release-notes
