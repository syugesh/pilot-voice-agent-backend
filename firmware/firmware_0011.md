# Firmware Release Notes: Motorola MB8611 Cable Modem - v4.3.17
...
## Summary
Release notes and deployment guidance for firmware version v4.3.17 on the Motorola MB8611 Cable Modem, distributed to Comcast Fiber subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Motorola MB8611 Cable Modem devices in the Comcast fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, motorola mb8611 cable modem, fiber, comcast, release-notes
