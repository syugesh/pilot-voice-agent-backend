# Firmware Release Notes: Arris SB8200 Cable Modem - v5.4.24
...
## Summary
Release notes and deployment guidance for firmware version v5.4.24 on the Arris SB8200 Cable Modem, distributed to Verizon Cable/DOCSIS subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Arris SB8200 Cable Modem devices in the Verizon fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, arris sb8200 cable modem, cable/docsis, verizon, release-notes
