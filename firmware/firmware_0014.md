# Firmware Release Notes: Nokia G-1425G-A ONT - v7.6.8
...
## Summary
Release notes and deployment guidance for firmware version v7.6.8 on the Nokia G-1425G-A ONT, distributed to Airtel 5G Home Internet subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Nokia G-1425G-A ONT devices in the Airtel fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, nokia g-1425g-a ont, 5g home internet, airtel, release-notes
