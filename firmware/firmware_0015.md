# Firmware Release Notes: Calix 844G-1 ONT - v3.7.15
...
## Summary
Release notes and deployment guidance for firmware version v3.7.15 on the Calix 844G-1 ONT, distributed to Jio GPON subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Calix 844G-1 ONT devices in the Jio fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, calix 844g-1 ont, gpon, jio, release-notes
