# Firmware Release Notes: Cisco DPC3941T Gateway - v5.9.29
...
## Summary
Release notes and deployment guidance for firmware version v5.9.29 on the Cisco DPC3941T Gateway, distributed to Cisco TAC Fiber subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Cisco DPC3941T Gateway devices in the Cisco TAC fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, cisco dpc3941t gateway, fiber, cisco tac, release-notes
