# Firmware Release Notes: Huawei HG8245H ONT - v6.0.6
...
## Summary
Release notes and deployment guidance for firmware version v6.0.6 on the Huawei HG8245H ONT, distributed to Xfinity Cable/DOCSIS subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Huawei HG8245H ONT devices in the Xfinity fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, huawei hg8245h ont, cable/docsis, xfinity, release-notes
