# Firmware Release Notes: Zyxel VMG8825 DSL Router - v7.1.13
...
## Summary
Release notes and deployment guidance for firmware version v7.1.13 on the Zyxel VMG8825 DSL Router, distributed to BT Openreach Fixed Wireless subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Zyxel VMG8825 DSL Router devices in the BT Openreach fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, zyxel vmg8825 dsl router, fixed wireless, bt openreach, release-notes
