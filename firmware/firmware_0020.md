# Firmware Release Notes: ASUS RT-AX88U Router - v3.2.20
...
## Summary
Release notes and deployment guidance for firmware version v3.2.20 on the ASUS RT-AX88U Router, distributed to Deutsche Telekom 5G Home Internet subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible ASUS RT-AX88U Router devices in the Deutsche Telekom fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, asus rt-ax88u router, 5g home internet, deutsche telekom, release-notes
