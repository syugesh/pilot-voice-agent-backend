# Firmware Release Notes: Sagemcom F@st 5566 Gateway - v4.3.27

**Document ID:** FW-0021
**Category:** Firmware
**Device:** Sagemcom F@st 5566 Gateway
**Applicable Technology:** GPON
**Release Version:** v4.3.27
**Release Date:** 2025-04-13
**Distributed By:** T-Mobile Network Engineering

## Summary
Release notes and deployment guidance for firmware version v4.3.27 on the Sagemcom F@st 5566 Gateway, distributed to T-Mobile GPON subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Sagemcom F@st 5566 Gateway devices in the T-Mobile fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, sagemcom f@st 5566 gateway, gpon, t-mobile, release-notes
