# Firmware Release Notes: Ubiquiti Dream Machine - v5.4.4

**Document ID:** FW-0022
**Category:** Firmware
**Device:** Ubiquiti Dream Machine
**Applicable Technology:** DSL
**Release Version:** v5.4.4
**Release Date:** 2025-05-14
**Distributed By:** Comcast Network Engineering

## Summary
Release notes and deployment guidance for firmware version v5.4.4 on the Ubiquiti Dream Machine, distributed to Comcast DSL subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Ubiquiti Dream Machine devices in the Comcast fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, ubiquiti dream machine, dsl, comcast, release-notes
