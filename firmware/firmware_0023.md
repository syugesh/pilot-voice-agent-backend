# Firmware Release Notes: Motorola MB8611 Cable Modem - v6.5.11
...
## Summary
Release notes and deployment guidance for firmware version v6.5.11 on the Motorola MB8611 Cable Modem, distributed to Verizon Fiber subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Motorola MB8611 Cable Modem devices in the Verizon fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, motorola mb8611 cable modem, fiber, verizon, release-notes
