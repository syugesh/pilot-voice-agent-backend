# Firmware Release Notes: Netgear Nighthawk RAX50 Router - v3.7.25

**Document ID:** FW-0025
**Category:** Firmware
**Device:** Netgear Nighthawk RAX50 Router
**Applicable Technology:** Fixed Wireless
**Release Version:** v3.7.25
**Release Date:** 2025-08-17
**Distributed By:** Airtel Network Engineering

## Summary
Release notes and deployment guidance for firmware version v3.7.25 on the Netgear Nighthawk RAX50 Router, distributed to Airtel Fixed Wireless subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Netgear Nighthawk RAX50 Router devices in the Airtel fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, netgear nighthawk rax50 router, fixed wireless, airtel, release-notes
