# Firmware Release Notes: TP-Link Archer AX73 - v6.0.16

**Document ID:** FW-0028
**Category:** Firmware
**Device:** TP-Link Archer AX73
**Applicable Technology:** DSL
**Release Version:** v6.0.16
**Release Date:** 2025-02-11
**Distributed By:** Cisco TAC Network Engineering

## Summary
Release notes and deployment guidance for firmware version v6.0.16 on the TP-Link Archer AX73, distributed to Cisco TAC DSL subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible TP-Link Archer AX73 devices in the Cisco TAC fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, tp-link archer ax73, dsl, cisco tac, release-notes
