# Firmware Release Notes: Cisco DPC3941T Gateway - v7.1.23
...
## Summary
Release notes and deployment guidance for firmware version v7.1.23 on the Cisco DPC3941T Gateway, distributed to Xfinity Fiber subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Cisco DPC3941T Gateway devices in the Xfinity fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, cisco dpc3941t gateway, fiber, xfinity, release-notes
