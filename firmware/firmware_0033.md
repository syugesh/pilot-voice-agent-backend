# Firmware Release Notes: Sagemcom F@st 5566 Gateway - v6.5.21

**Document ID:** FW-0033
**Category:** Firmware
**Device:** Sagemcom F@st 5566 Gateway
**Applicable Technology:** GPON
**Release Version:** v6.5.21
**Release Date:** 2025-07-16
**Distributed By:** Comcast Network Engineering

## Summary
Release notes and deployment guidance for firmware version v6.5.21 on the Sagemcom F@st 5566 Gateway, distributed to Comcast GPON subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Sagemcom F@st 5566 Gateway devices in the Comcast fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, sagemcom f@st 5566 gateway, gpon, comcast, release-notes
