# Firmware Release Notes: Ubiquiti Dream Machine - v7.6.28

**Document ID:** FW-0034
**Category:** Firmware
**Device:** Ubiquiti Dream Machine
**Applicable Technology:** DSL
**Release Version:** v7.6.28
**Release Date:** 2025-08-17
**Distributed By:** Verizon Network Engineering

## Summary
Release notes and deployment guidance for firmware version v7.6.28 on the Ubiquiti Dream Machine, distributed to Verizon DSL subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Ubiquiti Dream Machine devices in the Verizon fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, ubiquiti dream machine, dsl, verizon, release-notes
