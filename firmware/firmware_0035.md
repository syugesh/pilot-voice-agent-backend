# Firmware Release Notes: Motorola MB8611 Cable Modem - v3.7.5

**Document ID:** FW-0035
**Category:** Firmware
**Device:** Motorola MB8611 Cable Modem
**Applicable Technology:** Fiber
**Release Version:** v3.7.5
**Release Date:** 2025-09-18
**Distributed By:** Vodafone Network Engineering

## Summary
Release notes and deployment guidance for firmware version v3.7.5 on the Motorola MB8611 Cable Modem, distributed to Vodafone Fiber subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Motorola MB8611 Cable Modem devices in the Vodafone fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, motorola mb8611 cable modem, fiber, vodafone, release-notes
