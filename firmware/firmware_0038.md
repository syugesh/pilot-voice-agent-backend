# Firmware Release Notes: Nokia G-1425G-A ONT - v6.0.26
...
## Summary
Release notes and deployment guidance for firmware version v6.0.26 on the Nokia G-1425G-A ONT, distributed to AT&T 5G Home Internet subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Nokia G-1425G-A ONT devices in the AT&T fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, nokia g-1425g-a ont, 5g home internet, at&t, release-notes
