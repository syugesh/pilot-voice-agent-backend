# Firmware Release Notes: Zyxel VMG8825 DSL Router - v6.5.1
...
## Summary
Release notes and deployment guidance for firmware version v6.5.1 on the Zyxel VMG8825 DSL Router, distributed to T-Mobile Fixed Wireless subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Zyxel VMG8825 DSL Router devices in the T-Mobile fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, zyxel vmg8825 dsl router, fixed wireless, t-mobile, release-notes
