# Firmware Release Notes: Ubiquiti Dream Machine - v4.8.22
...
## Summary
Release notes and deployment guidance for firmware version v4.8.22 on the Ubiquiti Dream Machine, distributed to Vodafone DSL subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Ubiquiti Dream Machine devices in the Vodafone fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, ubiquiti dream machine, dsl, vodafone, release-notes
