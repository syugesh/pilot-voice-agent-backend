# Firmware Release Notes: Netgear Nighthawk RAX50 Router - v7.1.13
...
## Summary
Release notes and deployment guidance for firmware version v7.1.13 on the Netgear Nighthawk RAX50 Router, distributed to AT&T Fixed Wireless subscribers via automated TR-069 (CWMP) provisioning.
...
1. **Canary Phase:** 1% of eligible Netgear Nighthawk RAX50 Router devices in the AT&T fleet, monitored for 48 hours for anomaly rates in reboot frequency and support ticket volume.
...
## Tags
firmware, netgear nighthawk rax50 router, fixed wireless, at&t, release-notes
