# Installation Guide: Vodafone Fiber Service with Gateway Router

**Document ID:** INSTALL-0013
**Category:** Installation Guide
**Applies To:** Vodafone Fiber, Gateway Router
**Audience:** Field Technicians / Self-Install Customers
**Last Reviewed:** 2025-08-14

## Summary
Provides the complete step-by-step installation and activation procedure for new Vodafone Fiber service using a Gateway Router, covering both professional installation and customer self-install kits.
...
## Tags
installation, fiber, gateway router, vodafone, provisioning
