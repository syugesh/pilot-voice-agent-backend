# Installation Guide: Xfinity DSL Service with WiFi 6 Router

**Document ID:** INSTALL-0018
**Category:** Installation Guide
**Applies To:** Xfinity DSL, WiFi 6 Router
**Audience:** Field Technicians / Self-Install Customers
**Last Reviewed:** 2025-08-10

## Summary
Provides the complete step-by-step installation and activation procedure for new Xfinity DSL service using a WiFi 6 Router, covering both professional installation and customer self-install kits.
...
## Tags
installation, dsl, wifi 6 router, xfinity, provisioning
