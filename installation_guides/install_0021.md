# Installation Guide: T-Mobile Fixed Wireless Service with Gateway Router

**Document ID:** INSTALL-0021
**Category:** Installation Guide
**Applies To:** T-Mobile Fixed Wireless, Gateway Router
**Audience:** Field Technicians / Self-Install Customers
**Last Reviewed:** 2025-08-13

## Summary
Provides the complete step-by-step installation and activation procedure for new T-Mobile Fixed Wireless service using a Gateway Router, covering both professional installation and customer self-install kits.
...
## Tags
installation, fixed wireless, gateway router, t-mobile, provisioning
