# Installation Guide: Xfinity GPON Service with Gateway Router

**Document ID:** INSTALL-0029
...
## Summary
Provides the complete step-by-step installation and activation procedure for new Xfinity GPON service using a Gateway Router, covering both professional installation and customer self-install kits.
...
## Tags
installation, gpon, gateway router, xfinity, provisioning
