# Installation Guide: BT Openreach DSL Service with SFP Optical Module

**Document ID:** INSTALL-0030
...
## Summary
Provides the complete step-by-step installation and activation procedure for new BT Openreach DSL service using a SFP Optical Module, covering both professional installation and customer self-install kits.
...
## Tags
installation, dsl, sfp optical module, bt openreach, provisioning
