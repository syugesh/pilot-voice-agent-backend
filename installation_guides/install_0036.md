# Installation Guide: Airtel DSL Service with VoIP ATA

**Document ID:** INSTALL-0036
...
## Summary
Provides the complete step-by-step installation and activation procedure for new Airtel DSL service using a VoIP ATA, covering both professional installation and customer self-install kits.
...
## Tags
installation, dsl, voip ata, airtel, provisioning
