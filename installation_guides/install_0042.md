# Installation Guide: Deutsche Telekom DSL Service with WiFi 6 Router

**Document ID:** INSTALL-0042
...
## Summary
Provides the complete step-by-step installation and activation procedure for new Deutsche Telekom DSL service using a WiFi 6 Router, covering both professional installation and customer self-install kits.
...
## Tags
installation, dsl, wifi 6 router, deutsche telekom, provisioning
