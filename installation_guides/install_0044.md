# Installation Guide: Comcast Cable/DOCSIS Service with VoIP ATA

**Document ID:** INSTALL-0044
...
## Summary
Provides the complete step-by-step installation and activation procedure for new Comcast Cable/DOCSIS service using a VoIP ATA, covering both professional installation and customer self-install kits.
...
## Tags
installation, cable/docsis, voip ata, comcast, provisioning
