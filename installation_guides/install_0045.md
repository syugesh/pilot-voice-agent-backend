# Installation Guide: Verizon Fixed Wireless Service with Gateway Router

**Document ID:** INSTALL-0045
...
## Summary
Provides the complete step-by-step installation and activation procedure for new Verizon Fixed Wireless service using a Gateway Router, covering both professional installation and customer self-install kits.
...
## Installation Steps
1. **Physical Connection:** Connect the coax or telephone line from the wall jack to the WAN port of the Gateway Router using the provided cable.
...
## Tags
installation, fixed wireless, gateway router, verizon, provisioning
