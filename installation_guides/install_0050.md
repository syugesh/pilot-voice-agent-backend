# Installation Guide: Cisco TAC Cable/DOCSIS Service with WiFi 6 Router

**Document ID:** INSTALL-0050
...
## Summary
Provides the complete step-by-step installation and activation procedure for new Cisco TAC Cable/DOCSIS service using a WiFi 6 Router, covering both professional installation and customer self-install kits.
...
## Tags
installation, cable/docsis, wifi 6 router, cisco tac, provisioning
