...
## Summary
Technical reference document explaining pppoe session establishment explained for support staff who need to understand the underlying network architecture behind AT&T Cable/DOCSIS services when diagnosing complex customer issues.
...
## Technical Details
In a typical AT&T deployment, subscriber traffic originates at the customer's CPE (Cable/DOCSIS modem/router/ONT) and traverses the access network before reaching the aggregation layer. Key elements relevant to pppoe session establishment explained include:
...
- Product Manual: MAN-0002

## Tags
network-architecture, cable/docsis, at&t, tier2-reference, diagnostics
