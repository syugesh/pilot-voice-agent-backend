...
## Summary
Technical reference document explaining dns resolution path for subscriber traffic for support staff who need to understand the underlying network architecture behind Jio 5G Home Internet services when diagnosing complex customer issues.
...
## Technical Details
In a typical Jio deployment, subscriber traffic originates at the customer's CPE (5G Home Internet modem/router/ONT) and traverses the access network before reaching the aggregation layer. Key elements relevant to dns resolution path for subscriber traffic include:
...
## Tags
network-architecture, 5g home internet, jio, tier2-reference, diagnostics
