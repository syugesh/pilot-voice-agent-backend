...
## Summary
Technical reference document explaining gpon architecture: olt, ont, and splitters for support staff who need to understand the underlying network architecture behind AT&T GPON services when diagnosing complex customer issues.
...
## Technical Details
In a typical AT&T deployment, subscriber traffic originates at the customer's CPE (GPON modem/router/ONT) and traverses the access network before reaching the aggregation layer. Key elements relevant to gpon architecture: olt, ont, and splitters include:
...
- Product Manual: MAN-0035

## Tags
network-architecture, gpon, at&t, tier2-reference, diagnostics
