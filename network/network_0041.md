...
## Summary
Technical reference document explaining network address translation (nat) types and gaming for support staff who need to understand the underlying network architecture behind Verizon DSL services when diagnosing complex customer issues.
...
## Technical Details
In a typical Verizon deployment, subscriber traffic originates at the customer's CPE (DSL modem/router/ONT) and traverses the access network before reaching the aggregation layer. Key elements relevant to network address translation (nat) types and gaming include:
...
## Tags
network-architecture, dsl, verizon, tier2-reference, diagnostics
