...
## Summary
Technical reference document explaining ipv4 to ipv6 transition architecture for support staff who need to understand the underlying network architecture behind AT&T 5G Home Internet services when diagnosing complex customer issues.
...
## Technical Details
In a typical AT&T deployment, subscriber traffic originates at the customer's CPE (5G Home Internet modem/router/ONT) and traverses the access network before reaching the aggregation layer. Key elements relevant to ipv4 to ipv6 transition architecture include:
...
## Tags
network-architecture, 5g home internet, at&t, tier2-reference, diagnostics
