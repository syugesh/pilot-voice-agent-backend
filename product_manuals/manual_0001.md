# Product Manual: Netgear Nighthawk RAX50 Router

**Document ID:** MAN-0001
**Category:** Product Manual
**Device Type:** Netgear Nighthawk RAX50 Router
**Compatible Service:** Verizon Fiber
**Firmware Baseline:** v3.1.3
**Last Reviewed:** 2025-10-22

## Summary
Technical reference manual for support agents covering the Netgear Nighthawk RAX50 Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Verizon Fiber deployments.

## Hardware Overview
The Netgear Nighthawk RAX50 Router supports Fiber connectivity and includes an integrated 2.5G multi-gig WAN/LAN port, dual-band 802.11ax WiFi radios, and no integrated telephony ports.
...
3. **Firmware Update:** Navigate to Administration > Firmware Update; the device checks the Verizon provisioning server automatically and can be triggered manually.
4. **Factory Reset:** Hold the recessed reset button for 10-15 seconds until all LEDs flash simultaneously.

## Related Documents
- Installation Guide: INSTALL-0002
- Firmware Release Notes: FW-0002
- Troubleshooting Guide: TS-0002

## Tags
product-manual, fiber, netgear nighthawk rax50 router, hardware-reference, verizon
