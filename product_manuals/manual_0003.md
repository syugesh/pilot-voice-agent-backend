...
**Document ID:** MAN-0003
**Category:** Product Manual
**Device Type:** Calix 844G-1 ONT
**Compatible Service:** Airtel Fixed Wireless
**Firmware Baseline:** v5.3.9
**Last Reviewed:** 2025-10-24

## Summary
Technical reference manual for support agents covering the Calix 844G-1 ONT, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Airtel Fixed Wireless deployments.
...
## Related Documents
- Installation Guide: INSTALL-0004
- Firmware Release Notes: FW-0004
- Troubleshooting Guide: TS-0004

## Tags
product-manual, fixed wireless, calix 844g-1 ont, hardware-reference, airtel
