...
**Document ID:** MAN-0004
**Category:** Product Manual
**Device Type:** TP-Link Archer AX73
**Compatible Service:** Jio 5G Home Internet
**Firmware Baseline:** v6.4.12
**Last Reviewed:** 2025-10-25

## Summary
Technical reference manual for support agents covering the TP-Link Archer AX73, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Jio 5G Home Internet deployments.
...
## Related Documents
- Installation Guide: INSTALL-0005
- Firmware Release Notes: FW-0005
- Troubleshooting Guide: TS-0005

## Tags
product-manual, 5g home internet, tp-link archer ax73, hardware-reference, jio
