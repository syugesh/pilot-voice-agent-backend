...
**Document ID:** MAN-0005
**Category:** Product Manual
**Device Type:** Cisco DPC3941T Gateway
**Compatible Service:** AT&T GPON
**Firmware Baseline:** v2.5.15
**Last Reviewed:** 2025-10-26

## Summary
Technical reference manual for support agents covering the Cisco DPC3941T Gateway, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for AT&T GPON deployments.
...
## Related Documents
- Installation Guide: INSTALL-0006
- Firmware Release Notes: FW-0006
- Troubleshooting Guide: TS-0006

## Tags
product-manual, gpon, cisco dpc3941t gateway, hardware-reference, at&t
