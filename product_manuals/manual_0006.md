...
**Document ID:** MAN-0006
**Category:** Product Manual
**Device Type:** Huawei HG8245H ONT
**Compatible Service:** Cisco TAC DSL
**Firmware Baseline:** v3.6.18
**Last Reviewed:** 2025-10-27

## Summary
Technical reference manual for support agents covering the Huawei HG8245H ONT, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Cisco TAC DSL deployments.
...
## Related Documents
- Installation Guide: INSTALL-0007
- Firmware Release Notes: FW-0007
- Troubleshooting Guide: TS-0007

## Tags
product-manual, dsl, huawei hg8245h ont, hardware-reference, cisco tac
