...
**Document ID:** MAN-0008
**Category:** Product Manual
**Device Type:** ASUS RT-AX88U Router
**Compatible Service:** BT Openreach Cable/DOCSIS
**Firmware Baseline:** v5.8.4
**Last Reviewed:** 2025-10-21

## Summary
Technical reference manual for support agents covering the ASUS RT-AX88U Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for BT Openreach Cable/DOCSIS deployments.
...
3. **Firmware Update:** Navigate to Administration > Firmware Update; the device checks the BT Openreach provisioning server automatically and can be triggered manually.
4. **Factory Reset:** Hold the recessed reset button for 10-15 seconds until all LEDs flash simultaneously.

## Related Documents
- Installation Guide: INSTALL-0009
- Firmware Release Notes: FW-0009
- Troubleshooting Guide: TS-0009

## Tags
product-manual, cable/docsis, asus rt-ax88u router, hardware-reference, bt openreach
