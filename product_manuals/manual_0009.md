...
**Document ID:** MAN-0009
**Category:** Product Manual
**Device Type:** Sagemcom F@st 5566 Gateway
**Compatible Service:** Deutsche Telekom Fixed Wireless
**Firmware Baseline:** v6.9.7
**Last Reviewed:** 2025-10-22

## Summary
Technical reference manual for support agents covering the Sagemcom F@st 5566 Gateway, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Deutsche Telekom Fixed Wireless deployments.
...
## Related Documents
- Installation Guide: INSTALL-0010
- Firmware Release Notes: FW-0010
- Troubleshooting Guide: TS-0010

## Tags
product-manual, fixed wireless, sagemcom f@st 5566 gateway, hardware-reference, deutsche telekom
