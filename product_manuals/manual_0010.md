...
**Document ID:** MAN-0010
**Category:** Product Manual
**Device Type:** Ubiquiti Dream Machine
**Compatible Service:** T-Mobile 5G Home Internet
**Firmware Baseline:** v2.0.10
**Last Reviewed:** 2025-10-23

## Summary
Technical reference manual for support agents covering the Ubiquiti Dream Machine, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for T-Mobile 5G Home Internet deployments.
...
## Related Documents
- Installation Guide: INSTALL-0011
- Firmware Release Notes: FW-0011
- Troubleshooting Guide: TS-0011

## Tags
product-manual, 5g home internet, ubiquiti dream machine, hardware-reference, t-mobile
