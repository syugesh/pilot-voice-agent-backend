...
**Document ID:** MAN-0012
**Category:** Product Manual
**Device Type:** Arris SB8200 Cable Modem
**Compatible Service:** Verizon DSL
**Firmware Baseline:** v4.2.16
**Last Reviewed:** 2025-10-25

## Summary
Technical reference manual for support agents covering the Arris SB8200 Cable Modem, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Verizon DSL deployments.
...
## Related Documents
- Installation Guide: INSTALL-0013
- Firmware Release Notes: FW-0013
- Troubleshooting Guide: TS-0013

## Tags
product-manual, dsl, arris sb8200 cable modem, hardware-reference, verizon
