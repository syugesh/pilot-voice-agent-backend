...
**Document ID:** MAN-0015
**Category:** Product Manual
**Device Type:** Calix 844G-1 ONT
**Compatible Service:** Jio Fixed Wireless
**Firmware Baseline:** v2.5.5
**Last Reviewed:** 2025-10-28

## Summary
Technical reference manual for support agents covering the Calix 844G-1 ONT, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Jio Fixed Wireless deployments.
...
## Related Documents
- Installation Guide: INSTALL-0016
- Firmware Release Notes: FW-0016
- Troubleshooting Guide: TS-0016

## Tags
product-manual, fixed wireless, calix 844g-1 ont, hardware-reference, jio
