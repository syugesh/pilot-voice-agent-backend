...
**Document ID:** MAN-0016
**Category:** Product Manual
**Device Type:** TP-Link Archer AX73
**Compatible Service:** AT&T 5G Home Internet
**Firmware Baseline:** v3.6.8
**Last Reviewed:** 2025-10-21

## Summary
Technical reference manual for support agents covering the TP-Link Archer AX73, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for AT&T 5G Home Internet deployments.
...
## Related Documents
- Installation Guide: INSTALL-0017
- Firmware Release Notes: FW-0017
- Troubleshooting Guide: TS-0017

## Tags
product-manual, 5g home internet, tp-link archer ax73, hardware-reference, at&t
