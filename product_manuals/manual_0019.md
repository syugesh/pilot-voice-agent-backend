...
**Document ID:** MAN-0019
**Category:** Product Manual
**Device Type:** Zyxel VMG8825 DSL Router
**Compatible Service:** BT Openreach Fiber
**Firmware Baseline:** v6.9.17
**Last Reviewed:** 2025-10-24

## Summary
Technical reference manual for support agents covering the Zyxel VMG8825 DSL Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for BT Openreach Fiber deployments.
...
## Related Documents
- Installation Guide: INSTALL-0020
- Firmware Release Notes: FW-0020
- Troubleshooting Guide: TS-0020

## Tags
product-manual, fiber, zyxel vmg8825 dsl router, hardware-reference, bt openreach
