# Product Manual: ASUS RT-AX88U Router

**Document ID:** MAN-0020
**Category:** Product Manual
**Device Type:** ASUS RT-AX88U Router
**Compatible Service:** Deutsche Telekom Cable/DOCSIS
**Firmware Baseline:** v2.0.0
**Last Reviewed:** 2025-10-25

## Summary
Technical reference manual for support agents covering the ASUS RT-AX88U Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Deutsche Telekom Cable/DOCSIS deployments.

## Hardware Overview
The ASUS RT-AX88U Router supports Cable/DOCSIS connectivity and includes an integrated 4-port Gigabit Ethernet switch, dual-band 802.11ax WiFi radios, and no integrated telephony ports.
...
3. **Firmware Update:** Navigate to Administration > Firmware Update; the device checks the Deutsche Telekom provisioning server automatically and can be triggered manually.
4. **Factory Reset:** Hold the recessed reset button for 10-15 seconds until all LEDs flash simultaneously.

## Related Documents
- Installation Guide: INSTALL-0021
- Firmware Release Notes: FW-0021
- Troubleshooting Guide: TS-0021

## Tags
product-manual, cable/docsis, asus rt-ax88u router, hardware-reference, deutsche telekom
