...
**Document ID:** MAN-0021
**Category:** Product Manual
**Device Type:** Sagemcom F@st 5566 Gateway
**Compatible Service:** T-Mobile Fixed Wireless
**Firmware Baseline:** v3.1.3
**Last Reviewed:** 2025-10-26

## Summary
Technical reference manual for support agents covering the Sagemcom F@st 5566 Gateway, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for T-Mobile Fixed Wireless deployments.
...
## Related Documents
- Installation Guide: INSTALL-0022
- Firmware Release Notes: FW-0022
- Troubleshooting Guide: TS-0022

## Tags
product-manual, fixed wireless, sagemcom f@st 5566 gateway, hardware-reference, t-mobile
