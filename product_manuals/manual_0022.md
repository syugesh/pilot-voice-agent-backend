...
**Document ID:** MAN-0022
**Category:** Product Manual
**Device Type:** Ubiquiti Dream Machine
**Compatible Service:** Comcast 5G Home Internet
**Firmware Baseline:** v4.2.6
**Last Reviewed:** 2025-10-27

## Summary
Technical reference manual for support agents covering the Ubiquiti Dream Machine, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Comcast 5G Home Internet deployments.
...
## Related Documents
- Installation Guide: INSTALL-0023
- Firmware Release Notes: FW-0023
- Troubleshooting Guide: TS-0023

## Tags
product-manual, 5g home internet, ubiquiti dream machine, hardware-reference, comcast
