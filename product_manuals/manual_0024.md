# Product Manual: Arris SB8200 Cable Modem

**Document ID:** MAN-0024
**Category:** Product Manual
**Device Type:** Arris SB8200 Cable Modem
**Compatible Service:** Vodafone DSL
**Firmware Baseline:** v6.4.12
**Last Reviewed:** 2025-10-21

## Summary
Technical reference manual for support agents covering the Arris SB8200 Cable Modem, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Vodafone DSL deployments.

## Hardware Overview
The Arris SB8200 Cable Modem supports DSL connectivity and includes an integrated 4-port Gigabit Ethernet switch, dual-band 802.11ax WiFi radios, and an integrated VoIP ATA with two RJ-11 ports.
...
## Related Documents
- Installation Guide: INSTALL-0025
- Firmware Release Notes: FW-0025
- Troubleshooting Guide: TS-0025

## Tags
product-manual, dsl, arris sb8200 cable modem, hardware-reference, vodafone
