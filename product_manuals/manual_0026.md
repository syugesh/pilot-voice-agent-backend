...
**Document ID:** MAN-0026
**Category:** Product Manual
**Device Type:** Nokia G-1425G-A ONT
**Compatible Service:** Jio Cable/DOCSIS
**Firmware Baseline:** v3.6.18
**Last Reviewed:** 2025-10-23

## Summary
Technical reference manual for support agents covering the Nokia G-1425G-A ONT, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Jio Cable/DOCSIS deployments.
...
## Related Documents
- Installation Guide: INSTALL-0027
- Firmware Release Notes: FW-0027
- Troubleshooting Guide: TS-0027

## Tags
product-manual, cable/docsis, nokia g-1425g-a ont, hardware-reference, jio
