...
**Document ID:** MAN-0029
**Category:** Product Manual
**Device Type:** Cisco DPC3941T Gateway
**Compatible Service:** Xfinity GPON
**Firmware Baseline:** v6.9.7
**Last Reviewed:** 2025-10-26

## Summary
Technical reference manual for support agents covering the Cisco DPC3941T Gateway, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Xfinity GPON deployments.
...
## Related Documents
- Installation Guide: INSTALL-0030
- Firmware Release Notes: FW-0030
- Troubleshooting Guide: TS-0030

## Tags
product-manual, gpon, cisco dpc3941t gateway, hardware-reference, xfinity
