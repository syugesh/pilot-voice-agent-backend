...
**Document ID:** MAN-0030
**Category:** Product Manual
**Device Type:** Huawei HG8245H ONT
**Compatible Service:** BT Openreach DSL
**Firmware Baseline:** v2.0.10
**Last Reviewed:** 2025-10-27

## Summary
Technical reference manual for support agents covering the Huawei HG8245H ONT, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for BT Openreach DSL deployments.
...
## Related Documents
- Installation Guide: INSTALL-0031
- Firmware Release Notes: FW-0031
- Troubleshooting Guide: TS-0031

## Tags
product-manual, dsl, huawei hg8245h ont, hardware-reference, bt openreach
