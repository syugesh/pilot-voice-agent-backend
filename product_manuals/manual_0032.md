...
**Document ID:** MAN-0032
**Category:** Product Manual
**Device Type:** ASUS RT-AX88U Router
**Compatible Service:** T-Mobile Cable/DOCSIS
**Firmware Baseline:** v4.2.16
**Last Reviewed:** 2025-10-21

## Summary
Technical reference manual for support agents covering the ASUS RT-AX88U Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for T-Mobile Cable/DOCSIS deployments.
...
## Related Documents
- Installation Guide: INSTALL-0033
- Firmware Release Notes: FW-0033
- Troubleshooting Guide: TS-0033

## Tags
product-manual, cable/docsis, asus rt-ax88u router, hardware-reference, t-mobile
