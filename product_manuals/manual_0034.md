...
**Document ID:** MAN-0034
**Category:** Product Manual
**Device Type:** Ubiquiti Dream Machine
**Compatible Service:** Verizon 5G Home Internet
**Firmware Baseline:** v6.4.2
**Last Reviewed:** 2025-10-23

## Summary
Technical reference manual for support agents covering the Ubiquiti Dream Machine, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Verizon 5G Home Internet deployments.
...
## Related Documents
- Installation Guide: INSTALL-0035
- Firmware Release Notes: FW-0035
- Troubleshooting Guide: TS-0035

## Tags
product-manual, 5g home internet, ubiquiti dream machine, hardware-reference, verizon
