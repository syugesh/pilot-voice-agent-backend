...
**Document ID:** MAN-0035
**Category:** Product Manual
**Device Type:** Motorola MB8611 Cable Modem
**Compatible Service:** Vodafone GPON
**Firmware Baseline:** v2.5.5
**Last Reviewed:** 2025-10-24

## Summary
Technical reference manual for support agents covering the Motorola MB8611 Cable Modem, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Vodafone GPON deployments.
...
## Related Documents
- Installation Guide: INSTALL-0036
- Firmware Release Notes: FW-0036
- Troubleshooting Guide: TS-0036

## Tags
product-manual, gpon, motorola mb8611 cable modem, hardware-reference, vodafone
