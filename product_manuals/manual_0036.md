...
**Document ID:** MAN-0036
**Category:** Product Manual
**Device Type:** Arris SB8200 Cable Modem
**Compatible Service:** Airtel DSL
**Firmware Baseline:** v3.6.8
**Last Reviewed:** 2025-10-25

## Summary
Technical reference manual for support agents covering the Arris SB8200 Cable Modem, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Airtel DSL deployments.
...
## Related Documents
- Installation Guide: INSTALL-0037
- Firmware Release Notes: FW-0037
- Troubleshooting Guide: TS-0037

## Tags
product-manual, dsl, arris sb8200 cable modem, hardware-reference, airtel
