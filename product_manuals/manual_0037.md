...
**Document ID:** MAN-0037
**Category:** Product Manual
**Device Type:** Netgear Nighthawk RAX50 Router
**Compatible Service:** Jio Fiber
**Firmware Baseline:** v4.7.11
**Last Reviewed:** 2025-10-26

## Summary
Technical reference manual for support agents covering the Netgear Nighthawk RAX50 Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Jio Fiber deployments.
...
3. **Firmware Update:** Navigate to Administration > Firmware Update; the device checks the Jio provisioning server automatically and can be triggered manually.
4. **Factory Reset:** Hold the recessed reset button for 10-15 seconds until all LEDs flash simultaneously.

## Related Documents
- Installation Guide: INSTALL-0038
- Firmware Release Notes: FW-0038
- Troubleshooting Guide: TS-0038

## Tags
product-manual, fiber, netgear nighthawk rax50 router, hardware-reference, jio
