...
**Document ID:** MAN-0039
**Category:** Product Manual
**Device Type:** Calix 844G-1 ONT
**Compatible Service:** Cisco TAC Fixed Wireless
**Firmware Baseline:** v6.9.17
**Last Reviewed:** 2025-10-28

## Summary
Technical reference manual for support agents covering the Calix 844G-1 ONT, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Cisco TAC Fixed Wireless deployments.
...
## Related Documents
- Installation Guide: INSTALL-0040
- Firmware Release Notes: FW-0040
- Troubleshooting Guide: TS-0040

## Tags
product-manual, fixed wireless, calix 844g-1 ont, hardware-reference, cisco tac
