...
**Document ID:** MAN-0040
**Category:** Product Manual
**Device Type:** TP-Link Archer AX73
**Compatible Service:** Xfinity 5G Home Internet
**Firmware Baseline:** v2.0.0
**Last Reviewed:** 2025-10-21

## Summary
Technical reference manual for support agents covering the TP-Link Archer AX73, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Xfinity 5G Home Internet deployments.
...
## Related Documents
- Installation Guide: INSTALL-0041
- Firmware Release Notes: FW-0041
- Troubleshooting Guide: TS-0041

## Tags
product-manual, 5g home internet, tp-link archer ax73, hardware-reference, xfinity
