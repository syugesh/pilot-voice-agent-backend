# Product Manual: Cisco DPC3941T Gateway

**Document ID:** MAN-0041
**Category:** Product Manual
**Device Type:** Cisco DPC3941T Gateway
**Compatible Service:** BT Openreach GPON
**Firmware Baseline:** v3.1.3
**Last Reviewed:** 2025-10-22

## Summary
Technical reference manual for support agents covering the Cisco DPC3941T Gateway, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for BT Openreach GPON deployments.

## Hardware Overview
The Cisco DPC3941T Gateway supports GPON connectivity and includes an integrated 2.5G multi-gig WAN/LAN port, dual-band 802.11ax WiFi radios, and no integrated telephony ports.
...
## Related Documents
- Installation Guide: INSTALL-0042
- Firmware Release Notes: FW-0042
- Troubleshooting Guide: TS-0042

## Tags
product-manual, gpon, cisco dpc3941t gateway, hardware-reference, bt openreach
