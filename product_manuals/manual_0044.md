...
**Document ID:** MAN-0044
**Category:** Product Manual
**Device Type:** ASUS RT-AX88U Router
**Compatible Service:** Comcast Cable/DOCSIS
**Firmware Baseline:** v6.4.12
**Last Reviewed:** 2025-10-25

## Summary
Technical reference manual for support agents covering the ASUS RT-AX88U Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Comcast Cable/DOCSIS deployments.
...
## Related Documents
- Installation Guide: INSTALL-0045
- Firmware Release Notes: FW-0045
- Troubleshooting Guide: TS-0045

## Tags
product-manual, cable/docsis, asus rt-ax88u router, hardware-reference, comcast
