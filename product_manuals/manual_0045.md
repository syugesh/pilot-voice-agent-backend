...
**Document ID:** MAN-0045
**Category:** Product Manual
**Device Type:** Sagemcom F@st 5566 Gateway
**Compatible Service:** Verizon Fixed Wireless
**Firmware Baseline:** v2.5.15
**Last Reviewed:** 2025-10-26

## Summary
Technical reference manual for support agents covering the Sagemcom F@st 5566 Gateway, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Verizon Fixed Wireless deployments.
...
## Related Documents
- Installation Guide: INSTALL-0046
- Firmware Release Notes: FW-0046
- Troubleshooting Guide: TS-0046

## Tags
product-manual, fixed wireless, sagemcom f@st 5566 gateway, hardware-reference, verizon
