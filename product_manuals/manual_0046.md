# Product Manual: Ubiquiti Dream Machine

**Document ID:** MAN-0046
**Category:** Product Manual
**Device Type:** Ubiquiti Dream Machine
**Compatible Service:** Vodafone 5G Home Internet
**Firmware Baseline:** v3.6.18
**Last Reviewed:** 2025-10-27

## Summary
Technical reference manual for support agents covering the Ubiquiti Dream Machine, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Vodafone 5G Home Internet deployments.

## Hardware Overview
The Ubiquiti Dream Machine supports 5G Home Internet connectivity and includes an integrated 4-port Gigabit Ethernet switch, dual-band 802.11ax WiFi radios, and no integrated telephony ports.
...
3. **Firmware Update:** Navigate to Administration > Firmware Update; the device checks the Vodafone provisioning server automatically and can be triggered manually.
4. **Factory Reset:** Hold the recessed reset button for 10-15 seconds until all LEDs flash simultaneously.

## Related Documents
- Installation Guide: INSTALL-0047
- Firmware Release Notes: FW-0047
- Troubleshooting Guide: TS-0047

## Tags
product-manual, 5g home internet, ubiquiti dream machine, hardware-reference, vodafone
