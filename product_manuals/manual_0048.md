...
**Document ID:** MAN-0048
**Category:** Product Manual
**Device Type:** Arris SB8200 Cable Modem
**Compatible Service:** Jio DSL
**Firmware Baseline:** v5.8.4
**Last Reviewed:** 2025-10-21

## Summary
Technical reference manual for support agents covering the Arris SB8200 Cable Modem, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for Jio DSL deployments.
...
## Related Documents
- Installation Guide: INSTALL-0049
- Firmware Release Notes: FW-0049
- Troubleshooting Guide: TS-0049

## Tags
product-manual, dsl, arris sb8200 cable modem, hardware-reference, jio
