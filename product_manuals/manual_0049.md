...
**Document ID:** MAN-0049
**Category:** Product Manual
**Device Type:** Netgear Nighthawk RAX50 Router
**Compatible Service:** AT&T Fiber
**Firmware Baseline:** v6.9.7
**Last Reviewed:** 2025-10-22

## Summary
Technical reference manual for support agents covering the Netgear Nighthawk RAX50 Router, including hardware specifications, LED indicator meanings, default configuration, and supported protocols for AT&T Fiber deployments.
...
## Related Documents
- Installation Guide: INSTALL-0050
- Firmware Release Notes: FW-0050
- Troubleshooting Guide: TS-0050

## Tags
product-manual, fiber, netgear nighthawk rax50 router, hardware-reference, at&t
