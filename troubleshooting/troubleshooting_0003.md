# Troubleshooting Guide: VoIP call quality degradation on 5G Home Internet Service

**Document ID:** TS-0003
**Category:** Troubleshooting
**Applies To:** Cisco TAC 5G Home Internet, VoIP ATA
**Severity:** High
**Last Reviewed:** 2025-12-04

## Summary
Step-by-step diagnostic procedure for resolving VoIP call quality degradation reported by subscribers on Cisco TAC 5G Home Internet circuits terminating on a VoIP ATA.

## Problem Description
Customers report VoIP call quality degradation. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports VoIP call quality degradation, sometimes with duration and frequency data.
- VoIP ATA status LEDs show abnormal state (blinking amber, solid red, or no PPP/online light).
...
## Root Cause
Investigation typically traces this issue to a damaged or dirty fiber connector at the ONT causing intermittent LOS alarms.

## Resolution Steps
1. Pull the VoIP ATA event log via the local admin UI or remotely via TR-069/ACS and identify the timestamp of the last successful WAN authentication.
...
## Tags
troubleshooting, 5g home internet, voip ata, cisco tac, network-diagnostics
