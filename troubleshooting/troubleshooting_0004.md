# Troubleshooting Guide: VPN tunnel not establishing on GPON Service

**Document ID:** TS-0004
**Category:** Troubleshooting
**Applies To:** Xfinity GPON, Gateway Router
**Severity:** Medium
**Last Reviewed:** 2025-12-05

## Summary
Step-by-step diagnostic procedure for resolving VPN tunnel not establishing reported by subscribers on Xfinity GPON circuits terminating on a Gateway Router.

## Problem Description
Customers report VPN tunnel not establishing. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports VPN tunnel not establishing, sometimes with duration and frequency data.
...
## Root Cause
Investigation typically traces this issue to asymmetric routing caused by a secondary router operating in router mode instead of bridge mode.
...
## Tags
troubleshooting, gpon, gateway router, xfinity, network-diagnostics
