# Troubleshooting Guide: Router firmware update failure on DSL Service

**Document ID:** TS-0005
**Category:** Troubleshooting
**Applies To:** BT Openreach DSL, SFP Optical Module
**Severity:** Low
**Last Reviewed:** 2025-12-06

## Summary
Step-by-step diagnostic procedure for resolving router firmware update failure reported by subscribers on BT Openreach DSL circuits terminating on a SFP Optical Module.
...
## Tags
troubleshooting, dsl, sfp optical module, bt openreach, network-diagnostics
