# Troubleshooting Guide: High latency and jitter on Cable/DOCSIS Service
...
## Summary
Step-by-step diagnostic procedure for resolving high latency and jitter reported by subscribers on T-Mobile Cable/DOCSIS circuits terminating on a DSL Modem.
...
## Root Cause
Investigation typically traces this issue to rate limiting applied at the edge due to a suspected compromised device generating excessive traffic.
...
## Tags
troubleshooting, cable/docsis, dsl modem, t-mobile, network-diagnostics
