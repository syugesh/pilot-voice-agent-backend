...
## Summary
Step-by-step diagnostic procedure for resolving port forwarding not working reported by subscribers on Comcast Fixed Wireless circuits terminating on a Cable Modem.
...
## Tags
troubleshooting, fixed wireless, cable modem, comcast, network-diagnostics
