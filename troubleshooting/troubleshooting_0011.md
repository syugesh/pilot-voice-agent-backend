# Troubleshooting Guide: Fiber signal loss (Rx power low) on DSL Service

**Document ID:** TS-0011
**Category:** Troubleshooting
**Applies To:** Airtel DSL, VoIP ATA
**Severity:** Low
**Last Reviewed:** 2025-12-03

## Summary
Step-by-step diagnostic procedure for resolving fiber signal loss (Rx power low) reported by subscribers on Airtel DSL circuits terminating on a VoIP ATA.
...
## Tags
troubleshooting, dsl, voip ata, airtel, network-diagnostics
