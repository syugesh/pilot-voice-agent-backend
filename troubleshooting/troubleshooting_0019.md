# Troubleshooting Guide: DHCP lease exhaustion on Cable/DOCSIS Service

**Document ID:** TS-0019
**Category:** Troubleshooting
**Applies To:** Comcast Cable/DOCSIS, VoIP ATA
**Severity:** Medium
**Last Reviewed:** 2025-12-02

## Summary
Step-by-step diagnostic procedure for resolving DHCP lease exhaustion reported by subscribers on Comcast Cable/DOCSIS circuits terminating on a VoIP ATA.

## Problem Description
Customers report DHCP lease exhaustion. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports DHCP lease exhaustion, sometimes with duration and frequency data.
...
## Tags
troubleshooting, cable/docsis, voip ata, comcast, network-diagnostics
