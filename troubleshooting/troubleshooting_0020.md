# Troubleshooting Guide: DNS resolution errors on Fixed Wireless Service

**Document ID:** TS-0020
**Category:** Troubleshooting
**Applies To:** Verizon Fixed Wireless, Gateway Router
**Severity:** Low
**Last Reviewed:** 2025-12-03

## Summary
Step-by-step diagnostic procedure for resolving DNS resolution errors reported by subscribers on Verizon Fixed Wireless circuits terminating on a Gateway Router.

## Problem Description
Customers report DNS resolution errors. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports DNS resolution errors, sometimes with duration and frequency data.
...
## Tags
troubleshooting, fixed wireless, gateway router, verizon, network-diagnostics
