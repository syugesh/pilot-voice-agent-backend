# Troubleshooting Guide: ONT red light / LOS alarm on Fixed Wireless Service

**Document ID:** TS-0026
**Category:** Troubleshooting
**Applies To:** Xfinity Fixed Wireless, Mesh Extender
**Severity:** Low
**Last Reviewed:** 2025-12-09

## Summary
Step-by-step diagnostic procedure for resolving ONT red light / LOS alarm reported by subscribers on Xfinity Fixed Wireless circuits terminating on a Mesh Extender.

## Problem Description
Customers report ONT red light / LOS alarm. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports ONT red light / LOS alarm, sometimes with duration and frequency data.
...
## Root Cause
Investigation typically traces this issue to channel congestion caused by overlapping WiFi networks in a multi-dwelling unit.
...
## Tags
troubleshooting, fixed wireless, mesh extender, xfinity, network-diagnostics
