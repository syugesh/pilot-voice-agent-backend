# Troubleshooting Guide: High latency and jitter on 5G Home Internet Service

**Document ID:** TS-0027
**Category:** Troubleshooting
**Applies To:** BT Openreach 5G Home Internet, VoIP ATA
**Severity:** High
**Last Reviewed:** 2025-12-01

## Summary
Step-by-step diagnostic procedure for resolving high latency and jitter reported by subscribers on BT Openreach 5G Home Internet circuits terminating on a VoIP ATA.

## Problem Description
Customers report high latency and jitter. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports high latency and jitter, sometimes with duration and frequency data.
...
## Root Cause
Investigation typically traces this issue to an IPv6 prefix delegation (DHCPv6-PD) failure between the ONT and the ISP core router.
...
## Tags
troubleshooting, 5g home internet, voip ata, bt openreach, network-diagnostics
