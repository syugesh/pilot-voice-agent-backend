# Troubleshooting Guide: Port forwarding not working on GPON Service

**Document ID:** TS-0028
**Category:** Troubleshooting
**Applies To:** Deutsche Telekom GPON, Gateway Router
**Severity:** Medium
**Last Reviewed:** 2025-12-02

## Summary
Step-by-step diagnostic procedure for resolving port forwarding not working reported by subscribers on Deutsche Telekom GPON circuits terminating on a Gateway Router.
...
## Tags
troubleshooting, gpon, gateway router, deutsche telekom, network-diagnostics
