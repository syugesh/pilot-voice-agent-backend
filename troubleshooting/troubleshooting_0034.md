# Troubleshooting Guide: Static IP configuration issue on GPON Service

**Document ID:** TS-0034
**Category:** Troubleshooting
**Applies To:** Jio GPON, Mesh Extender
**Severity:** Medium
**Last Reviewed:** 2025-12-08

## Summary
Step-by-step diagnostic procedure for resolving static IP configuration issue reported by subscribers on Jio GPON circuits terminating on a Mesh Extender.

## Problem Description
Customers report static IP configuration issue. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports static IP configuration issue, sometimes with duration and frequency data.
...
## Tags
troubleshooting, gpon, mesh extender, jio, network-diagnostics
