...
**Applies To:** Cisco TAC Fiber, Gateway Router
**Severity:** High
**Last Reviewed:** 2025-12-01

## Summary
Step-by-step diagnostic procedure for resolving slow download speeds reported by subscribers on Cisco TAC Fiber circuits terminating on a Gateway Router.
...
## Tags
troubleshooting, fiber, gateway router, cisco tac, network-diagnostics
