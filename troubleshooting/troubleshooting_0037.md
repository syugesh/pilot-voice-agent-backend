# Troubleshooting Guide: No internet access on Cable/DOCSIS Service

**Document ID:** TS-0037
**Category:** Troubleshooting
**Applies To:** Xfinity Cable/DOCSIS, SFP Optical Module
**Severity:** Medium
**Last Reviewed:** 2025-12-02

## Summary
Step-by-step diagnostic procedure for resolving no internet access reported by subscribers on Xfinity Cable/DOCSIS circuits terminating on a SFP Optical Module.

## Problem Description
Customers report no internet access. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports no internet access, sometimes with duration and frequency data.
...
## Tags
troubleshooting, cable/docsis, sfp optical module, xfinity, network-diagnostics
