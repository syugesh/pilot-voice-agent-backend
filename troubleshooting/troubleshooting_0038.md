...
**Applies To:** BT Openreach Fixed Wireless, ONT
**Severity:** Low
**Last Reviewed:** 2025-12-03

## Summary
Step-by-step diagnostic procedure for resolving PPPoE authentication failure reported by subscribers on BT Openreach Fixed Wireless circuits terminating on a ONT.
...
- ONT status LEDs show abnormal state (blinking amber, solid red, or no PPP/online light).
...
## Resolution Steps
1. Pull the ONT event log via the local admin UI or remotely via TR-069/ACS and identify the timestamp of the last successful WAN authentication.
...
## Tags
troubleshooting, fixed wireless, ont, bt openreach, network-diagnostics
