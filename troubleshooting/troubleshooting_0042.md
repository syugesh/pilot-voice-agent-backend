# Troubleshooting Guide: IPv6 not provisioning on Fiber Service

**Document ID:** TS-0042
**Category:** Troubleshooting
**Applies To:** Verizon Fiber, Mesh Extender
**Severity:** High
**Last Reviewed:** 2025-12-07

## Summary
Step-by-step diagnostic procedure for resolving IPv6 not provisioning reported by subscribers on Verizon Fiber circuits terminating on a Mesh Extender.
...
## Tags
troubleshooting, fiber, mesh extender, verizon, network-diagnostics
