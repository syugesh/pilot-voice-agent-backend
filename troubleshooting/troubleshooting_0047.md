# Troubleshooting Guide: High latency and jitter on DSL Service

**Document ID:** TS-0047
**Category:** Troubleshooting
**Applies To:** Cisco TAC DSL, DSL Modem
**Severity:** Low
**Last Reviewed:** 2025-12-03

## Summary
Step-by-step diagnostic procedure for resolving high latency and jitter reported by subscribers on Cisco TAC DSL circuits terminating on a DSL Modem.
...
## Tags
troubleshooting, dsl, dsl modem, cisco tac, network-diagnostics
