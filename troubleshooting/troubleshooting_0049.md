# Troubleshooting Guide: Double NAT causing gaming issues on Cable/DOCSIS Service

**Document ID:** TS-0049
**Category:** Troubleshooting
**Applies To:** BT Openreach Cable/DOCSIS, WiFi 6 Router
**Severity:** Medium
**Last Reviewed:** 2025-12-05

## Summary
Step-by-step diagnostic procedure for resolving double NAT causing gaming issues reported by subscribers on BT Openreach Cable/DOCSIS circuits terminating on a WiFi 6 Router.

## Problem Description
Customers report double NAT causing gaming issues. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports double NAT causing gaming issues, sometimes with duration and frequency data.
...
## Tags
troubleshooting, cable/docsis, wifi 6 router, bt openreach, network-diagnostics
