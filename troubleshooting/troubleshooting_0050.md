# Troubleshooting Guide: Modem not syncing with DSLAM on Fixed Wireless Service

**Document ID:** TS-0050
**Category:** Troubleshooting
**Applies To:** Deutsche Telekom Fixed Wireless, Mesh Extender
**Severity:** Low
**Last Reviewed:** 2025-12-06

## Summary
Step-by-step diagnostic procedure for resolving modem not syncing with DSLAM reported by subscribers on Deutsche Telekom Fixed Wireless circuits terminating on a Mesh Extender.

## Problem Description
Customers report modem not syncing with DSLAM. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports modem not syncing with DSLAM, sometimes with duration and frequency data.
- Mesh Extender status LEDs show abnormal state (blinking amber, solid red, or no PPP/online light).
...
## Root Cause
Investigation typically traces this issue to an outdated modem firmware incompatible with the latest DOCSIS 3.1 OFDM channel bonding group.

## Resolution Steps
1. Pull the Mesh Extender event log via the local admin UI or remotely via TR-069/ACS and identify the timestamp of the last successful WAN authentication.
...
## Tags
troubleshooting, fixed wireless, mesh extender, deutsche telekom, network-diagnostics
