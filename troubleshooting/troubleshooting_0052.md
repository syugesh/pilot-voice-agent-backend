# Troubleshooting Guide: Wireless client authentication timeout on GPON Service

**Document ID:** TS-0052
**Category:** Troubleshooting
**Applies To:** Comcast GPON, Gateway Router
**Severity:** Medium
**Last Reviewed:** 2025-12-08

## Summary
Step-by-step diagnostic procedure for resolving wireless client authentication timeout reported by subscribers on Comcast GPON circuits terminating on a Gateway Router.
...
## Tags
troubleshooting, gpon, gateway router, comcast, network-diagnostics
