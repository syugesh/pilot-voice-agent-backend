# Troubleshooting Guide: Bandwidth throttling complaints on DSL Service

**Document ID:** TS-0053
**Category:** Troubleshooting
**Applies To:** Verizon DSL, SFP Optical Module
**Severity:** Low
**Last Reviewed:** 2025-12-09

## Summary
Step-by-step diagnostic procedure for resolving bandwidth throttling complaints reported by subscribers on Verizon DSL circuits terminating on a SFP Optical Module.
...
## Tags
troubleshooting, dsl, sfp optical module, verizon, network-diagnostics
