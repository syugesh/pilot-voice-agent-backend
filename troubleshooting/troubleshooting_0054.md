# Troubleshooting Guide: Static IP configuration issue on Fiber Service

**Document ID:** TS-0054
**Category:** Troubleshooting
**Applies To:** Vodafone Fiber, ONT
**Severity:** High
**Last Reviewed:** 2025-12-01

## Summary
Step-by-step diagnostic procedure for resolving static IP configuration issue reported by subscribers on Vodafone Fiber circuits terminating on a ONT.
...
## Tags
troubleshooting, fiber, ont, vodafone, network-diagnostics
