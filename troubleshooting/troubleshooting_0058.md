# Troubleshooting Guide: PPPoE authentication failure on GPON Service

**Document ID:** TS-0058
**Category:** Troubleshooting
**Applies To:** Cisco TAC GPON, Mesh Extender
**Severity:** Medium
**Last Reviewed:** 2025-12-05

## Summary
Step-by-step diagnostic procedure for resolving PPPoE authentication failure reported by subscribers on Cisco TAC GPON circuits terminating on a Mesh Extender.
...
- Escalation Policy: ESC-0009

## Tags
troubleshooting, gpon, mesh extender, cisco tac, network-diagnostics
