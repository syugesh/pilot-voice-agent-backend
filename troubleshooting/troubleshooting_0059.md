# Troubleshooting Guide: DHCP lease exhaustion on DSL Service

**Document ID:** TS-0059
**Category:** Troubleshooting
**Applies To:** Xfinity DSL, VoIP ATA
**Severity:** Low
**Last Reviewed:** 2025-12-06

## Summary
Step-by-step diagnostic procedure for resolving DHCP lease exhaustion reported by subscribers on Xfinity DSL circuits terminating on a VoIP ATA.
...
## Tags
troubleshooting, dsl, voip ata, xfinity, network-diagnostics
