# Troubleshooting Guide: DNS resolution errors on Fiber Service

**Document ID:** TS-0060
**Category:** Troubleshooting
**Applies To:** BT Openreach Fiber, Gateway Router
**Severity:** High
**Last Reviewed:** 2025-12-07

## Summary
Step-by-step diagnostic procedure for resolving DNS resolution errors reported by subscribers on BT Openreach Fiber circuits terminating on a Gateway Router.
...
## Tags
troubleshooting, fiber, gateway router, bt openreach, network-diagnostics
