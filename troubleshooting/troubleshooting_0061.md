# Troubleshooting Guide: WiFi signal weak on 5GHz band on Cable/DOCSIS Service

**Document ID:** TS-0061
**Category:** Troubleshooting
**Applies To:** Deutsche Telekom Cable/DOCSIS, SFP Optical Module
**Severity:** Medium
**Last Reviewed:** 2025-12-08

## Summary
Step-by-step diagnostic procedure for resolving WiFi signal weak on 5GHz band reported by subscribers on Deutsche Telekom Cable/DOCSIS circuits terminating on a SFP Optical Module.

## Problem Description
Customers report WiFi signal weak on 5GHz band. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports WiFi signal weak on 5GHz band, sometimes with duration and frequency data.
...
## Tags
troubleshooting, cable/docsis, sfp optical module, deutsche telekom, network-diagnostics
