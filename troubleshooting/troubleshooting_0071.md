...
**Applies To:** BT Openreach DSL, DSL Modem
**Severity:** Low
**Last Reviewed:** 2025-12-09

## Summary
Step-by-step diagnostic procedure for resolving fiber signal loss (Rx power low) reported by subscribers on BT Openreach DSL circuits terminating on a DSL Modem.
...
## Tags
troubleshooting, dsl, dsl modem, bt openreach, network-diagnostics
