# Troubleshooting Guide: Static IP configuration issue on Fixed Wireless Service

**Document ID:** TS-0074
**Category:** Troubleshooting
**Applies To:** Comcast Fixed Wireless, Mesh Extender
**Severity:** Low
**Last Reviewed:** 2025-12-03

## Summary
Step-by-step diagnostic procedure for resolving static IP configuration issue reported by subscribers on Comcast Fixed Wireless circuits terminating on a Mesh Extender.
...
## Root Cause
Investigation typically traces this issue to a mismatched pre-shared key or IKEv2 policy on the VPN concentrator.
...
## Tags
troubleshooting, fixed wireless, mesh extender, comcast, network-diagnostics
