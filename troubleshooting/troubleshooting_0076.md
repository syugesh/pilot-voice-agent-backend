# Troubleshooting Guide: Slow download speeds on GPON Service

**Document ID:** TS-0076
**Category:** Troubleshooting
**Applies To:** Vodafone GPON, Gateway Router
**Severity:** Medium
**Last Reviewed:** 2025-12-05

## Summary
Step-by-step diagnostic procedure for resolving slow download speeds reported by subscribers on Vodafone GPON circuits terminating on a Gateway Router.
...
## Tags
troubleshooting, gpon, gateway router, vodafone, network-diagnostics
