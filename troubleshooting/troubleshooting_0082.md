# Troubleshooting Guide: IPv6 not provisioning on GPON Service

**Document ID:** TS-0082
**Category:** Troubleshooting
**Applies To:** BT Openreach GPON, Mesh Extender
**Severity:** Medium
**Last Reviewed:** 2025-12-02

## Summary
Step-by-step diagnostic procedure for resolving IPv6 not provisioning reported by subscribers on BT Openreach GPON circuits terminating on a Mesh Extender.

## Problem Description
Customers report IPv6 not provisioning. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports IPv6 not provisioning, sometimes with duration and frequency data.
...
## Tags
troubleshooting, gpon, mesh extender, bt openreach, network-diagnostics
