# Troubleshooting Guide: VPN tunnel not establishing on Fiber Service

**Document ID:** TS-0084
**Category:** Troubleshooting
**Applies To:** T-Mobile Fiber, Gateway Router
**Severity:** High
**Last Reviewed:** 2025-12-04

## Summary
Step-by-step diagnostic procedure for resolving VPN tunnel not establishing reported by subscribers on T-Mobile Fiber circuits terminating on a Gateway Router.
...
## Root Cause
Investigation typically traces this issue to DHCP scope exhaustion on the CMTS/OLT due to high subscriber density.
...
## Tags
troubleshooting, fiber, gateway router, t-mobile, network-diagnostics
