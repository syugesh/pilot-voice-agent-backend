...
**Applies To:** Jio DSL, WiFi 6 Router
**Severity:** Low
**Last Reviewed:** 2025-12-09

## Summary
Step-by-step diagnostic procedure for resolving double NAT causing gaming issues reported by subscribers on Jio DSL circuits terminating on a WiFi 6 Router.
...
## Tags
troubleshooting, dsl, wifi 6 router, jio, network-diagnostics
