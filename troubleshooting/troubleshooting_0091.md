# Troubleshooting Guide: Fiber signal loss (Rx power low) on Cable/DOCSIS Service

**Document ID:** TS-0091
**Category:** Troubleshooting
**Applies To:** Cisco TAC Cable/DOCSIS, VoIP ATA
**Severity:** Medium
**Last Reviewed:** 2025-12-02

## Summary
Step-by-step diagnostic procedure for resolving fiber signal loss (Rx power low) reported by subscribers on Cisco TAC Cable/DOCSIS circuits terminating on a VoIP ATA.

## Problem Description
Customers report fiber signal loss (Rx power low). This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports fiber signal loss (Rx power low), sometimes with duration and frequency data.
...
## Root Cause
Investigation typically traces this issue to high optical attenuation on the fiber link exceeding the -28dBm receiver threshold.
...
## Tags
troubleshooting, cable/docsis, voip ata, cisco tac, network-diagnostics
