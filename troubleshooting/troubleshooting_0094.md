...
**Applies To:** Deutsche Telekom GPON, ONT
**Severity:** Medium
**Last Reviewed:** 2025-12-05

## Summary
Step-by-step diagnostic procedure for resolving static IP configuration issue reported by subscribers on Deutsche Telekom GPON circuits terminating on a ONT.
...
## Tags
troubleshooting, gpon, ont, deutsche telekom, network-diagnostics
