# Troubleshooting Guide: PPPoE authentication failure on Fixed Wireless Service

**Document ID:** TS-0098
**Category:** Troubleshooting
**Applies To:** Vodafone Fixed Wireless, Mesh Extender
**Severity:** Low
**Last Reviewed:** 2025-12-09

## Summary
Step-by-step diagnostic procedure for resolving PPPoE authentication failure reported by subscribers on Vodafone Fixed Wireless circuits terminating on a Mesh Extender.

## Problem Description
Customers report PPPoE authentication failure. This may manifest during peak hours (7 PM - 11 PM local time) or intermittently throughout the day, and is frequently accompanied by elevated packet loss or authentication retries.

## Symptoms
- Subscriber reports PPPoE authentication failure, sometimes with duration and frequency data.
...
## Tags
troubleshooting, fixed wireless, mesh extender, vodafone, network-diagnostics
