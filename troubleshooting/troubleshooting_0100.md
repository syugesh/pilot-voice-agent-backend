# Troubleshooting Guide: DNS resolution errors on GPON Service

**Document ID:** TS-0100
**Category:** Troubleshooting
**Applies To:** Jio GPON, Gateway Router
**Severity:** Medium
**Last Reviewed:** 2025-12-02

## Summary
Step-by-step diagnostic procedure for resolving DNS resolution errors reported by subscribers on Jio GPON circuits terminating on a Gateway Router.
...
## Tags
troubleshooting, gpon, gateway router, jio, network-diagnostics
